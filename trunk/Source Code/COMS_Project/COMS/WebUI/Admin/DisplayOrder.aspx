...
<ul>
        <li><asp:LinkButton ID="lnkSave" runat="server" onclick="lnkSave_Click">Save</asp:LinkButton>
        ...
        <li><asp:LinkButton ID="lnkBack" runat="server" onclick="lnkBack_Click" >Back</asp:LinkButton></li>
</ul>
...
<table class="entry_table" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="entry_data" style="width: 106px">Date: <asp:TextBox ID="txtCreateDate" runat="server" BorderWidth="1" ReadOnly="true" />
        ...
        <tr>
            <td class="entry_label" style="width: 106px">1.Customer</td>
            <td class="entry_data" colspan="3"><asp:DropDownList ID="ddlCustomer" 
                    runat="server" style="margin-bottom: 0px"></asp:DropDownList></td>
             <td class="entry_label" style="width: 87px">Set Code</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtSetCode" runat="server" BorderWidth="1" 
                    MaxLength="10" /></td>
        </tr>
        <tr>
            <td class="entry_label" style="width: 106px">2.Contact Person</td>
            ...
            <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtCylType" runat="server" BorderWidth="1" Width="40px" /></td>
             <td class="entry_label" style="width: 87px">Price Type</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtPriceType" runat="server" 
                    BorderWidth="1" MaxLength="10" /></td>
        </tr>
        <tr>
            <td class="entry_label" style="width: 106px">3.Product Name</td>
            <td class="entry_data" colspan="5"><asp:TextBox ID="txtProdName" runat="server" 
                    BorderWidth="1" Width="500px" MaxLength="255" /></td>
        </tr>
        <tr>
            <td class="entry_label" style="width: 106px">4.<asp:RadioButton ID="rBtnOrderTypeNew" GroupName="rBtnOrderType" runat="server" Text="New Order" TextAlign="Left" /></td>
             <td class="entry_data"><asp:RadioButton ID="rBtnOrderTypeReDo" GroupName="rBtnOrderType" runat="server" Text="Re-Order" TextAlign="Left" /></td>
             <td class="entry_label"><asp:CheckBox ID="chkBxChangeFile" runat="server" Text="Change File" TextAlign="Left" /></td>
             <td class="entry_data" style="width: 22px">Redo: <asp:TextBox ID="txtRedoPct" runat="server" BorderWidth="1" MaxLength="3" Width="40px" />%</td>
             <td class="entry_label" style="width: 87px">Belongs To Set <asp:TextBox ID="txtBelongsToSet" 
                     runat="server" BorderWidth="1" MaxLength="10" /></td>
             <td class="entry_data" style="width: 90px"><asp:CheckBox ID="chkBxOldCore" runat="server" Text="Old Core" TextAlign="Left" /></td>
        </tr>
        <tr>
            <td class="entry_label" colspan="2" rowspan="2">5.Product Specs (mm)</td>
             <td class="entry_label">Product Width</td>
            <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtProdWidth" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
             ...
             <td class="entry_label" style="width: 87px">Product Height</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtProdHeight" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
        ...
        <tr>
            ...
            <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtWidthStretch" runat="server" 
             ...
             <td class="entry_label" style="width: 87px">Height Stretch</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtHeightStretch" runat="server" 
                    BorderWidth="1" MaxLength="6" Text="0" />
        ...
        <tr>
            ...
            <td class="entry_data" style="width: 22px">
             ...
             <td class="entry_label" style="width: 87px">Circum. Dir. Repeats</td>
            <td class="entry_data" style="width: 90px">
        ...
        <tr>
            ...
            <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtWebPrintWidth" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
             ...
             <td class="entry_label" style="width: 87px">Total Web Width</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtWebTotalWidth" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
        ...
        <tr>
            ...
            <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtCylLength" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
             ...
             <td class="entry_label" style="width: 87px">Cyl. Circumference</td>
            <td class="entry_data" style="width: 90px"><asp:TextBox ID="txtCylCircum" runat="server" 
                    BorderWidth="1" Text="" MaxLength="7" />
        ...
        <tr>
            <td class="entry_label" rowspan="2" style="width: 106px">9.Eye Mark <asp:CheckBox ID="chkBxEyeMark" runat="server"/></td>
             <td class="entry_label" colspan="2">Dimension (mm)</td>
             <td class="entry_label" style="width: 22px">Color</td>
             <td class="entry_label" style="width: 87px">EM Sign</td>
             <td class="entry_data" style="width: 90px">Location: 
        ...
        <tr>
             <td class="entry_data">Height: <asp:TextBox ID="txtEMHeight" runat="server" BorderWidth="1" MaxLength="4" Width="40px" Text="" />
             ...
             <td class="entry_data">Width: <asp:TextBox ID="txtEMWidth" runat="server" BorderWidth="1" MaxLength="4" Width="40px" Text="" />
             ...
             <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtEMColor" runat="server" BorderWidth="1" MaxLength="4" Width="40px" Text="" /></td>
             <td class="entry_data" style="width: 87px"><asp:TextBox ID="txtEMSign" runat="server" BorderWidth="1" MaxLength="4" Width="40px" Text="" /></td>
             <td class="entry_data" style="width: 90px">
        ...
        <tr>
            <td class="entry_label" colspan="2">10.Key Hole: <asp:RadioButton ID="rBtnKeyHoleStd" GroupName="rBtnKeyHole" runat="server" Text="Standard" TextAlign="Left" /></td>
             <td class="entry_label"><asp:RadioButton ID="rBtnKeyHoleOther" GroupName="rBtnKeyHole" runat="server" Text="Other" TextAlign="Left" />
        ...
        <tr>
            <td class="entry_label" style="width: 106px">11. Color Count:</td>
             ...
             <td class="entry_data" style="width: 22px"><asp:TextBox ID="txtCylCount" runat="server" BorderWidth="1" 
             ...
             <td class="entry_label" style="width: 87px">12.Print Method: </td>
             <td class="entry_data" style="width: 90px">
        ...
        <tr>
            <td class="entry_label" style="width: 106px">13. Registration Mark:</td>
        ...
        <tr>
            <td class="entry_label" style="width: 106px">14.<asp:CheckBox ID="chkBxSplitLine" runat="server" Text="Splitting Line:" TextAlign="Left" /></td>
             <td class="entry_data">Size(mm):<asp:TextBox ID="txtSplitLineSize" runat="server" 
                     BorderWidth="1" Width="120px" MaxLength="9" /></td>
             <td class="entry_data"><asp:CheckBox ID="chkBxSplitLine2Side" runat="server" Text="2-sided" TextAlign="Left"/></td>
             <td class="entry_data" style="width: 22px">Color:<asp:TextBox ID="txtSplitLineColor" runat="server" 
                     BorderWidth="1" Width="40px" MaxLength="2" /></td>
            <td class="entry_label" style="width: 87px">15. Customer Code:</td>
             <td class="entry_data" style="width: 90px">
        ...
        <tr>
            <td class="entry_label" style="width: 106px">16.Printing Material:</td>
            ...
            <td class="entry_label" style="width: 90px">Other: <asp:TextBox ID="txtMaterialOther" runat="server" 
                    BorderWidth="1" Width="120px" MaxLength="10" /></td>
        </tr>
        <tr>
            <td class="entry_label" style="width: 106px">17.Result Based On:</td>
            ...
            <td class="entry_label" style="width: 90px">Other: <asp:TextBox ID="txtResultOther" runat="server" 
                    BorderWidth="1" Width="120px" MaxLength="20" /></td>
        </tr>
        <tr>
            <td class="entry_label" style="width: 106px">Image Orientation: </td>
            <td class="entry_data" colspan="5">
        ...
        <tr>
            <td class="entry_label" style="width: 106px">Receiving Staff:</td>
            ...
            <td class="entry_label" style="width: 87px">Priority:</td>
             <td class="entry_data" style="width: 90px"><asp:DropDownList ID="ddlPriority" runat="server"/></td>
        </tr>
    </table>
</asp:Content>
