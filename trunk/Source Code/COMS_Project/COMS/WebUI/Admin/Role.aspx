<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Role.aspx.cs" Inherits="WebUI.Admin.Role" %>
    ...
    <table class="entry_table" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="entry_label">
                Role Name</td>
            <td class="entry_data">
                <asp:TextBox BorderColor="black" ID="txtRoleName" runat="server" MaxLength="50" 
        ...
        <tr>
            ...
            <td class="entry_data">
                ...
                <asp:GridView ID="gvAccess" runat="server" Width="566px" CellPadding="4" 
                    GridLines="None" onrowdatabound="gvAccess_RowDataBound" CssClass="grid" 
                        ForeColor="#333333">
...
<asp:Content ID="Content4" ContentPlaceHolderID="OutputPlaceHolder" runat="server">
    ...
    onrowdatabound="gvResult_RowDataBound" ViewStateMode="Enabled" Width="100%" 
        onrowcommand="gvResult_RowCommand" CellPadding="4" GridLines="None" 
