    ...
    <table class="entry_table" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="entry_label">
                Staff Code</td>
            <td class="entry_data">
            <asp:TextBox BorderColor="black" ID="txtStaffCode" style="width:200px;" runat="server"></asp:TextBox>
            </td>
            <td class="entry_label">
                Bar Code</td>
            <td class="entry_data">
        ...
        <tr>
            <td class="entry_label">
                Username</td>
            <td class="entry_data">
            <asp:TextBox BorderColor="black" ID="txtUsername" style="width:200px;" runat="server"></asp:TextBox>
            </td>
            <td class="entry_label">
                Password
            </td>
