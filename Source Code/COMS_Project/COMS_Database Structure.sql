...
/****** Object:  Database [COMS]    Script Date: 10/23/2011 13:02:42 ******/
CREATE DATABASE [COMS] ON  PRIMARY 
( NAME = N'COMS', FILENAME = N'F:\mtech_svn\COMS_Database\COMS.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'COMS_log', FILENAME = N'F:\mtech_svn\COMS_Database\COMS_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
